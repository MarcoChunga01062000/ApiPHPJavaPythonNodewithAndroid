        ...
        client.post(url + urlParameter, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                if (statusCode == 200) {
                    ...
                    Toast.makeText(Python.this, "Saved succesfully...! " + resultado, Toast.LENGTH_LONG).show();
                    limpiar();
                    Intent intent = new Intent(getApplicationContext(), ListarActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(Python.this, "No se Registro", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                ...
                Toast.makeText(Python.this, "Mal: " + error, Toast.LENGTH_LONG).show();
            }
        });
        finish();
    }
