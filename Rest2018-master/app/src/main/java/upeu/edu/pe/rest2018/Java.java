...
public class Java extends AppCompatActivity {
    ...
    public void save(View view){
        ...
        String url = "http://" + ip + ":9090/usuarios/insert?";
        ...
        client.post(url + urlParameter, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                if (statusCode == 200) {
                    ...
                    Toast.makeText(Java.this, "Registro Guardado correctamente...! ", Toast.LENGTH_LONG).show();
                    limpiar();
                    Intent intent = new Intent(getApplicationContext(), ListarActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(Java.this, "No se Registro", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                ...
                Toast.makeText(Java.this, "Mal: " + error, Toast.LENGTH_LONG).show();
            }
        });
        finish();
    }
